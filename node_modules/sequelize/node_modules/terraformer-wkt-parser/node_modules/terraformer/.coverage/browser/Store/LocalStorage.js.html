...
<html lang="en">
<head>
    <title>Code coverage report for browser/Store/LocalStorage.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">browser/Store/LocalStorage.js</span></h1>
    <h2>
        
        Statements: <span class="metric">82.54% <small>(52 / 63)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">53.49% <small>(23 / 43)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">100% <small>(12 / 12)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">82.54% <small>(52 / 63)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
    </h2>
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">browser/Store/</a> &#187; LocalStorage.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >      root.Terraformer = {};</span>
    ...
    <span class="missing-if-branch" title="if path not taken"" >I</span>if(typeof root.Terraformer.Store === "undefined"){
<span class="cstat-no" title="statement not covered" >      root.Terraformer.Store = {};</span>
    }
...
&nbsp;
  ...
  LocalStorage.prototype.add = function(geojson, callback){
    <span class="missing-if-branch" title="if path not taken"" >I</span>if(geojson.type === "FeatureCollection"){
<span class="cstat-no" title="statement not covered" >      for (var i = 0; i &lt; geojson.features.length; i++) {</span>
<span class="cstat-no" title="statement not covered" >        this.set(geojson.features[i]);</span>
      }
    } else {
      this.set(geojson);
    }
    <span class="missing-if-branch" title="if path not taken"" >I</span>if ( callback ) { 
<span class="cstat-no" title="statement not covered" >      callback( null, geojson );</span>
    }
  };
&nbsp;
...
&nbsp;
  LocalStorage.prototype.set = function(feature){
    <span class="missing-if-branch" title="if path not taken"" >I</span>if ( callback ) { 
<span class="cstat-no" title="statement not covered" >      localStorage.setItem(this.key(feature.id), JSON.stringify(feature));</span>
    }
  };
&nbsp;
...
&nbsp;
  LocalStorage.prototype.toJSON = function(){
    ...
    for(var feature in localStorage){
      <span class="missing-if-branch" title="else path not taken"" >E</span>if(feature.match(this._key)){
...
&nbsp;
    for (var key in localStorage){
      <span class="missing-if-branch" title="else path not taken"" >E</span>if(key.match(this._key)){
