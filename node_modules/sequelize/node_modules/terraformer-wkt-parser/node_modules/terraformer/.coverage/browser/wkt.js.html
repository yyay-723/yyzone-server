...
<html lang="en">
<head>
    <title>Code coverage report for browser/wkt.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">browser/wkt.js</span></h1>
    <h2>
        
        Statements: <span class="metric">82.63% <small>(433 / 524)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">79.05% <small>(234 / 296)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">73.47% <small>(36 / 49)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">83.24% <small>(427 / 513)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
    </h2>
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">browser/</a> &#187; wkt.js</div>
</div>
<div class="body">
...
778
779
780</td><td class="line-coverage"><span class="cline-any cline-yes">1</span>
...
<span class="cline-any cline-yes">1247</span>
<span class="cline-any cline-yes">1247</span>
<span class="cline-any cline-yes">5139</span>
<span class="cline-any cline-yes">5139</span>
<span class="cline-any cline-yes">1247</span>
<span class="cline-any cline-yes">1247</span>
<span class="cline-any cline-yes">1247</span>
...
&nbsp;
  // Browser Global.
  <span class="missing-if-branch" title="else path not taken"" >E</span>if(typeof navigator === "object") {
...
<span class="cstat-no" title="statement not covered" >        lstack.length = lstack.length - n;</span>
    ...
    while (true) {
        ...
        if (typeof action === "undefined" || !action.length || !action[0]) {
            var errStr = "";
            <span class="missing-if-branch" title="else path not taken"" >E</span>if (!recovering) {
                expected = [];
                for (p in table[state])
                    if (this.terminals_[p] &amp;&amp; p &gt; 2) {
                        expected.push("'" + this.terminals_[p] + "'");
                    }
                <span class="missing-if-branch" title="else path not taken"" >E</span>if (this.lexer.showPosition) {
...
pastInput:function () {
        ...
        return (past.length &gt; 20 ? <span class="branch-0 cbranch-no" title="branch not covered" >'...':</span>'') + past.substr(-20).replace(/\n/g, "");
    },
upcomingInput:function () {
        var next = this.match;
        <span class="missing-if-branch" title="else path not taken"" >E</span>if (next.length &lt; 20) {
            next += this._input.substr(0, 20-next.length);
        }
        return (next.substr(0,20)+(next.length &gt; 20 ? <span class="branch-0 cbranch-no" title="branch not covered" >'...':</span>'')).replace(/\n/g, "");
    },
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Fri Aug 16 2013 16:01:02 GMT-0700 (PDT)</div>
</div>
