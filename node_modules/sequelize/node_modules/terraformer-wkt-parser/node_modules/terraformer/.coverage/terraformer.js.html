...
<div class="header high">
    ...
    <h2>
        ...
        Statements: <span class="metric">96.76% <small>(658 / 680)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">91.61% <small>(382 / 417)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">96.51% <small>(83 / 86)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">96.76% <small>(658 / 680)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
1412
1413
1414</td><td class="line-coverage"><span class="cline-any cline-yes">1</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">5514</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">1909</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">5594</span>
...
&nbsp;
      if (i === 0) {
        <span class="missing-if-branch" title="if path not taken"" >I</span>if (res &lt; 0) {
<span class="cstat-no" title="statement not covered" >          ltz = true;</span>
        } else {
          ltz = false;
        }
      } else {
        <span class="missing-if-branch" title="else path not taken"" >E</span>if (ltz &amp;&amp; (<span class="branch-1 cbranch-no" title="branch not covered" >res &gt; 0)</span> || !ltz &amp;&amp; (res &lt; 0)) {
          return false;
        }
      }
    }
  ...
  Primitive.prototype.convexHull = function(){
    ...
    if (this.type === 'Point') {
      ...
      if (this.coordinates &amp;&amp; this.coordinates.length &gt; 0) {
        ...
        <span class="missing-if-branch" title="if path not taken"" >I</span>if(coordinates.length &lt; 3){
<span class="cstat-no" title="statement not covered" >          return null;</span>
        }
      } else {
        return null;
...
<span class="cstat-no" title="statement not covered" >          return null;</span>
    ...
    } else <span class="missing-if-branch" title="else path not taken"" >E</span>if(this.type === "Feature"){
...
&nbsp;
&nbsp;
    <span class="missing-if-branch" title="else path not taken"" >E</span>if (this.type !== 'Point' &amp;&amp; this.type !== 'MultiPoint' &amp;&amp;
...
<span class="cstat-no" title="statement not covered" >    this.coordinates = closedPolygon(this.coordinates);</span>
  ...
  Polygon.prototype.holes = function() {
    holes = [];
    <span class="missing-if-branch" title="else path not taken"" >E</span>if (this.hasHoles()) {
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Wed Feb 11 2015 08:43:03 GMT-0800 (PST)</div>
</div>
