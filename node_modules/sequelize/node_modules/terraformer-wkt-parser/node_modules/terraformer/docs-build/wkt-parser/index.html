...
<html>
  ...
  <body class="wkt-parser wkt-parser_index" id="wrap">
    <nav>
  <ul>
    <li>
  ...
  <div class="doctoc drawer-nav drawer-top">
    ...
    <main class="docs main-content" id="main-content">
      <h1>WKT Parser</h1>
<div class='semantic-toc'><ol><li><a href='#using-the-wkt-parser'>Using the WKT Parser</a><ol><li><a href='#using-in-the-browser'>Using in the Browser</a></li><li><a href='#using-in-nodejs'>Using in Node.js</a></li><li><a href='#methods'>Methods</a><ol><li><a href='#wktparse'>WKT.parse(string)</a></li><li><a href='#wktconvert'>WKT.convert(geojson)</a></div>
...
<h2>
          <a id='using-the-wkt-parser' class='section-link'></a>
          <a href='#using-the-wkt-parser' class='header-link'>Link</a>
          Using the WKT Parser
          <a href='#' class='back-to-top-link'>Back to Top</a>
        </h2>
<p>The WKT parser can be used client-side in a browser and server-side via Node.js.</p>
<pre class="highlight javascript"><span class="c1">// parse a WKT string, converting it into a Terraformer.Primitive
</span><span class="kd">var</span> <span class="nx">geojson</span> <span class="o">=</span> <span class="nx">Terraformer</span><span class="p">.</span><span class="nx">WKT</span><span class="p">.</span><span class="nx">parse</span><span class="p">(</span><span class="s1">'LINESTRING (30 10, 10 30, 40 40)'</span><span class="p">);</span>

<span class="c1">// take a primitive and convert it into a WKT representation
</span><span class="kd">var</span> <span class="nx">polygon</span> <span class="o">=</span> <span class="nx">Terraformer</span><span class="p">.</span><span class="nx">WKT</span><span class="p">.</span><span class="nx">convert</span><span class="p">({</span>
...
<span class="nt">&lt;script </span><span class="na">src=</span><span class="s">&quot;terraformer-wkt-parser.min.js&quot;</span><span class="nt">&gt;&lt;/script&gt;</span>
<span class="nt">&lt;script&gt;</span>
  <span class="c1">//Terraformer and Terraformer.WKT will be defined.
...
<pre class="highlight plaintext">$ bower install terraformer-wkt-parser
</pre><h3>
...
<pre class="highlight javascript"><span class="kd">var</span> <span class="nx">WKT</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">'terraformer-wkt-parser'</span><span class="p">);</span>
...
<span class="c1">// Start using the parse and convert methods!
          ...
          <a id='wktparse' class='section-link'></a>
          <a href='#wktparse' class='header-link'>Link</a>
          WKT.parse(string)
          <a href='#' class='back-to-top-link'>Back to Top</a>
        </h4>
<p><code>Terraformer.WKT.parse(string)</code> - Converts a GeoJSON or a <a href="">Terraformer.Primitive</a> into WKT.</p>
<pre class="highlight javascript"><span class="kd">var</span> <span class="nx">geojson</span> <span class="o">=</span> <span class="nx">Terraformer</span><span class="p">.</span><span class="nx">WKT</span><span class="p">.</span><span class="nx">parse</span><span class="p">(</span><span class="s1">'LINESTRING (30 10, 10 30, 40 40)'</span><span class="p">);</span>
</pre><h4>
          <a id='wktconvert' class='section-link'></a>
          <a href='#wktconvert' class='header-link'>Link</a>
          WKT.convert(geojson)
          <a href='#' class='back-to-top-link'>Back to Top</a>
        </h4>
<p><code>Terraformer.WKT.convert(geoJSON)</code> will convert GeoJSON or a Terraformer Primitive to WKT.</p>
<h5>Example</h5><pre class="highlight javascript"><span class="kd">var</span> <span class="nx">polygon</span> <span class="o">=</span> <span class="nx">Terraformer</span><span class="p">.</span><span class="nx">WKT</span><span class="p">.</span><span class="nx">convert</span><span class="p">({</span>
  <span class="s2">&quot;type&quot;</span><span class="p">:</span> <span class="s2">&quot;Polygon&quot;</span><span class="p">,</span>
  <span class="s2">&quot;coordinates&quot;</span><span class="p">:</span> <span class="p">[</span>
    <span class="p">[</span> <span class="p">[</span><span class="mf">100.0</span><span class="p">,</span> <span class="mf">0.0</span><span class="p">],</span> <span class="p">[</span><span class="mf">101.0</span><span class="p">,</span> <span class="mf">0.0</span><span class="p">],</span> <span class="p">[</span><span class="mf">101.0</span><span class="p">,</span> <span class="mf">1.0</span><span class="p">],</span> <span class="p">[</span><span class="mf">100.0</span><span class="p">,</span> <span class="mf">1.0</span><span class="p">],</span> <span class="p">[</span><span class="mf">100.0</span><span class="p">,</span> <span class="mf">0.0</span><span class="p">]</span> <span class="p">],</span>
    <span class="p">[</span> <span class="p">[</span><span class="mf">100.2</span><span class="p">,</span> <span class="mf">0.2</span><span class="p">],</span> <span class="p">[</span><span class="mf">100.8</span><span class="p">,</span> <span class="mf">0.2</span><span class="p">],</span> <span class="p">[</span><span class="mf">100.8</span><span class="p">,</span> <span class="mf">0.8</span><span class="p">],</span> <span class="p">[</span><span class="mf">100.2</span><span class="p">,</span> <span class="mf">0.8</span><span class="p">],</span> <span class="p">[</span><span class="mf">100.2</span><span class="p">,</span> <span class="mf">0.2</span><span class="p">]</span> <span class="p">]</span>
