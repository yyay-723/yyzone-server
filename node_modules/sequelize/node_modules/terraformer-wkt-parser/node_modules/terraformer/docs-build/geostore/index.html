...
<p>GeoStores are broken into three parts: <a href="/documentation/geostore/data-stores">Data Stores</a>, <a href="/documentation/geostore/spatial-indexes">Spatial Indexes</a>, and <a href="/documentation/geostore/alternate-indexes">Alternate Indexes</a>.</p>

<p>More in-depth information can be found in <a href="/documentation/geostore/core-concepts">Core Concepts</a>.</p>
<h2>
...
<pre class="highlight javascript"><span class="p">{</span>
  ...
  <span class="s2">&quot;id&quot;</span><span class="p">:</span> <span class="s2">&quot;my id&quot;</span><span class="p">,</span>
...
<span class="nt">&lt;script </span><span class="na">src=</span><span class="s">&quot;terraformer-geostore.min.js&quot;</span><span class="nt">&gt;&lt;/script&gt;</span>
</pre>
...
<pre class="highlight javascript"><span class="c1">// create a new GeoStore using Memory and an RTree Index
</span><span class="kd">var</span> <span class="nx">store</span> <span class="o">=</span> <span class="k">new</span> <span class="nx">Terraformer</span><span class="p">.</span><span class="nx">GeoStore</span><span class="p">({</span>
...
<pre class="highlight javascript"><span class="c1">// require geostore, an RTree index, and a LevelDB data store
</span><span class="kd">var</span> <span class="nx">GeoStore</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">'terraformer-geostore'</span><span class="p">).</span><span class="nx">GeoStore</span><span class="p">;</span>
<span class="kd">var</span> <span class="nx">RTree</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">'terraformer-geostore-rtree'</span><span class="p">).</span><span class="nx">RTree</span><span class="p">;</span>
<span class="kd">var</span> <span class="nx">LevelStore</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">'terraformer-geostore-leveldb'</span><span class="p">).</span><span class="nx">LevelStore</span><span class="p">;</span>
</pre>
<p>Once the packages are in scope, it is very similar as using the GeoStore in the browser.</p>
<pre class="highlight javascript"><span class="kd">var</span> <span class="nx">store</span> <span class="o">=</span> <span class="k">new</span> <span class="nx">GeoStore</span><span class="p">({</span>
...
<p><em>Example:</em></p>
<pre class="highlight javascript"><span class="nx">store</span><span class="p">.</span><span class="nx">add</span><span class="p">(</span><span class="nx">geojson</span><span class="p">,</span> <span class="kd">function</span> <span class="p">(</span><span class="nx">err</span><span class="p">,</span> <span class="nx">res</span><span class="p">)</span> <span class="p">{</span>
  <span class="c1">// Node.js style callback
...
<p><em>Example:</em></p>
<pre class="highlight javascript"><span class="nx">store</span><span class="p">.</span><span class="nx">update</span><span class="p">(</span><span class="nx">geojson</span><span class="p">,</span> <span class="kd">function</span> <span class="p">(</span><span class="nx">err</span><span class="p">,</span> <span class="nx">res</span><span class="p">)</span> <span class="p">{</span>
  <span class="c1">// Node.js style callback
</span><span class="p">});</span>
</pre><h4>
...
<p><em>Example:</em></p>
<pre class="highlight javascript"><span class="nx">store</span><span class="p">.</span><span class="nx">remove</span><span class="p">(</span><span class="nx">id</span><span class="p">,</span> <span class="kd">function</span> <span class="p">(</span><span class="nx">err</span><span class="p">,</span> <span class="nx">res</span><span class="p">)</span> <span class="p">{</span>
  <span class="c1">// Node.js style callback
</span><span class="p">});</span>
</pre><h4>
...
<p><em>Example:</em></p>
<pre class="highlight javascript"><span class="nx">store</span><span class="p">.</span><span class="nx">get</span><span class="p">(</span><span class="nx">id</span><span class="p">,</span> <span class="kd">function</span> <span class="p">(</span><span class="nx">err</span><span class="p">,</span> <span class="nx">res</span><span class="p">)</span> <span class="p">{</span>
  <span class="c1">// Node.js style callback
</span><span class="p">});</span>
</pre><h4>
...
<p><em>Example:</em></p>
<pre class="highlight javascript"><span class="nx">store</span><span class="p">.</span><span class="nx">contains</span><span class="p">(</span><span class="nx">geojson</span><span class="p">,</span> <span class="kd">function</span> <span class="p">(</span><span class="nx">err</span><span class="p">,</span> <span class="nx">res</span><span class="p">)</span> <span class="p">{</span>
  <span class="c1">// Node.js style callback
</span><span class="p">});</span>
...
<p><em>Example:</em></p>
<pre class="highlight javascript"><span class="nx">store</span><span class="p">.</span><span class="nx">within</span><span class="p">(</span><span class="nx">geojson</span><span class="p">,</span> <span class="kd">function</span> <span class="p">(</span><span class="nx">err</span><span class="p">,</span> <span class="nx">res</span><span class="p">)</span> <span class="p">{</span>
  <span class="c1">// Node.js style callback
</span><span class="p">});</span>
...
<p><em>Example:</em></p>
<pre class="highlight javascript"><span class="kd">var</span> <span class="nx">stream</span> <span class="o">=</span> <span class="nx">store</span><span class="p">.</span><span class="nx">createReadStream</span><span class="p">();</span>
...
<span class="nx">stream</span><span class="p">.</span><span class="nx">on</span><span class="p">(</span><span class="s2">&quot;end&quot;</span><span class="p">,</span> <span class="kd">function</span> <span class="p">(</span><span class="nx">geojson</span><span class="p">)</span> <span class="p">{</span>
  <span class="c1">// final geojson object
</span><span class="p">});</span>
</pre>
    </main>
