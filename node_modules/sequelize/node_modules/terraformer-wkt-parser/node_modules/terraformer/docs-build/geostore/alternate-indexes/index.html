...
<pre class="highlight javascript"><span class="c1">// create an index on the properties.street value
</span><span class="nx">gs</span><span class="p">.</span><span class="nx">addIndex</span><span class="p">({</span>
...
<span class="c1">// create an index on the properties.crime value
</span><span class="nx">gs</span><span class="p">.</span><span class="nx">addIndex</span><span class="p">({</span>
...
<pre class="highlight javascript"><span class="nx">gs</span><span class="p">.</span><span class="nx">within</span><span class="p">(</span>
  ...
  <span class="p">{</span>
    ...
    <span class="p">},</span>
    <span class="s2">&quot;crime&quot;</span><span class="p">:</span> <span class="p">{</span>
      <span class="s2">&quot;equals&quot;</span><span class="p">:</span> <span class="s2">&quot;Arson&quot;</span>
    <span class="p">}</span>
  <span class="p">},</span>
...
<p><em>Example:</em></p>
<pre class="highlight javascript"><span class="nx">idx</span><span class="p">.</span><span class="nx">add</span><span class="p">(</span><span class="nx">value</span><span class="p">,</span> <span class="nx">id</span><span class="p">,</span> <span class="kd">function</span> <span class="p">(</span><span class="nx">err</span><span class="p">,</span> <span class="nx">res</span><span class="p">)</span> <span class="p">{</span>
  <span class="c1">// Node.js style callback
</span><span class="p">});</span>
</pre><h3>
