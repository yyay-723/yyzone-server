...
<p><em>Example:</em></p>
<pre class="highlight javascript"><span class="kd">var</span> <span class="nx">ds</span> <span class="o">=</span> <span class="k">new</span> <span class="nx">DataStore</span><span class="p">({</span>
...
<pre class="highlight javascript"><span class="c1">// get the id
</span><span class="kd">var</span> <span class="nx">id</span> <span class="o">=</span> <span class="nx">geojson</span><span class="p">.</span><span class="nx">id</span><span class="p">;</span>

<span class="c1">// store the data
</span><span class="k">this</span><span class="p">.</span><span class="nx">magicdb</span><span class="p">.</span><span class="nx">put</span><span class="p">(</span><span class="nx">geojson</span><span class="p">.</span><span class="nx">id</span><span class="p">,</span> <span class="nx">JSON</span><span class="p">.</span><span class="nx">stringify</span><span class="p">(</span><span class="nx">geojson</span><span class="p">));</span>
</pre>
...
<p><em>Example:</em></p>
<pre class="highlight javascript"><span class="nx">ds</span><span class="p">.</span><span class="nx">add</span><span class="p">(</span><span class="nx">geojson</span><span class="p">,</span> <span class="kd">function</span> <span class="p">(</span><span class="nx">err</span><span class="p">,</span> <span class="nx">res</span><span class="p">)</span> <span class="p">{</span>
...
<p><em>Example:</em></p>
<pre class="highlight javascript"><span class="nx">ds</span><span class="p">.</span><span class="nx">update</span><span class="p">(</span><span class="nx">geojson</span><span class="p">,</span> <span class="kd">function</span> <span class="p">(</span><span class="nx">err</span><span class="p">,</span> <span class="nx">res</span><span class="p">)</span> <span class="p">{</span>
  <span class="c1">// Node.js style callback
</span><span class="p">});</span>
</pre><h4>
...
<p><em>Example:</em></p>
<pre class="highlight javascript"><span class="nx">ds</span><span class="p">.</span><span class="nx">remove</span><span class="p">(</span><span class="nx">id</span><span class="p">,</span> <span class="kd">function</span> <span class="p">(</span><span class="nx">err</span><span class="p">,</span> <span class="nx">res</span><span class="p">)</span> <span class="p">{</span>
  <span class="c1">// Node.js style callback
</span><span class="p">});</span>
</pre><h4>
...
<p><em>Example:</em></p>
<pre class="highlight javascript"><span class="nx">ds</span><span class="p">.</span><span class="nx">get</span><span class="p">(</span><span class="nx">id</span><span class="p">,</span> <span class="kd">function</span> <span class="p">(</span><span class="nx">err</span><span class="p">,</span> <span class="nx">res</span><span class="p">)</span> <span class="p">{</span>
  <span class="c1">// Node.js style callback
</span><span class="p">});</span>
</pre>
    </main>
