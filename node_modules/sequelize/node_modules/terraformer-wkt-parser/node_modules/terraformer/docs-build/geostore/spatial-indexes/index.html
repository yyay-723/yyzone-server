...
<p><em>Example:</em></p>
<pre class="highlight javascript"><span class="kd">var</span> <span class="nx">si</span> <span class="o">=</span> <span class="k">new</span> <span class="nx">SpatialIndex</span><span class="p">({</span>
...
<p><em>Example:</em></p>
<pre class="highlight javascript"><span class="nx">si</span><span class="p">.</span><span class="nx">insert</span><span class="p">(</span><span class="nx">geojson</span><span class="p">,</span> <span class="nx">id</span><span class="p">,</span> <span class="kd">function</span> <span class="p">(</span><span class="nx">err</span><span class="p">,</span> <span class="nx">res</span><span class="p">)</span> <span class="p">{</span>
...
<p><em>Example:</em></p>
<pre class="highlight javascript"><span class="nx">si</span><span class="p">.</span><span class="nx">remove</span><span class="p">(</span><span class="nx">geojson</span><span class="p">,</span> <span class="nx">id</span><span class="p">,</span> <span class="kd">function</span> <span class="p">(</span><span class="nx">err</span><span class="p">,</span> <span class="nx">res</span><span class="p">)</span> <span class="p">{</span>
  <span class="c1">// Node.js style callback
</span><span class="p">});</span>
</pre><h4>
...
<p><em>Example:</em></p>
<pre class="highlight javascript"><span class="nx">si</span><span class="p">.</span><span class="nx">search</span><span class="p">(</span><span class="nx">geojson</span><span class="p">,</span> <span class="kd">function</span> <span class="p">(</span><span class="nx">err</span><span class="p">,</span> <span class="nx">res</span><span class="p">)</span> <span class="p">{</span>
  <span class="c1">// Node.js style callback
</span><span class="p">});</span>
</pre><h4>
...
<p><em>Example:</em></p>
<pre class="highlight javascript"><span class="nx">si</span><span class="p">.</span><span class="nx">within</span><span class="p">(</span><span class="nx">geojson</span><span class="p">,</span> <span class="kd">function</span> <span class="p">(</span><span class="nx">err</span><span class="p">,</span> <span class="nx">res</span><span class="p">)</span> <span class="p">{</span>
  <span class="c1">// Node.js style callback
</span><span class="p">});</span>
</pre>
    </main>
