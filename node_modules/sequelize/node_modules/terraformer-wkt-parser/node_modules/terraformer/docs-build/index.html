...
<p>The core Terraformer library provides a series of <code>Terraformer.Primitves</code> which wrap GeoJSON objects for additional functionality and a series of <code>Terraformer.Tools</code> for manipulating and performing calculations on coordinates.</p>

<p>You can also use the core library to seeing if an object contains or intersects another obejct, convert and object to a different spatial reference or transform an objects coordinates.</p>
...
<pre class="highlight javascript"><span class="c1">// parse ArcGIS JSON, convert it to a Terraformer.Primitive
</span><span class="kd">var</span> <span class="nx">primitive</span> <span class="o">=</span> <span class="nx">Terraformer</span><span class="p">.</span><span class="nx">ArcGIS</span><span class="p">.</span><span class="nx">parse</span><span class="p">({</span>
...
<span class="c1">// take a Terraformer.Primitive or GeoJSON and convert it to ArcGIS JSON
</span><span class="kd">var</span> <span class="nx">point</span> <span class="o">=</span> <span class="nx">Terraformer</span><span class="p">.</span><span class="nx">ArcGIS</span><span class="p">.</span><span class="nx">convert</span><span class="p">({</span>
...
<pre class="highlight javascript"><span class="c1">// parse a WKT file, convert it into a primitive
</span><span class="kd">var</span> <span class="nx">primitive</span> <span class="o">=</span> <span class="nx">Terraformer</span><span class="p">.</span><span class="nx">WKT</span><span class="p">.</span><span class="nx">parse</span><span class="p">(</span><span class="s1">'LINESTRING (30 10, 10 30, 40 40)'</span><span class="p">);</span>
